...
public class TransactionListAdapter2 extends RecyclerView.Adapter<TransactionListAdapter2.TransViewHolder> implements Filterable {
    ...
    public TransactionListAdapter2(List<NewtransactionEntity> mTransactions) {
